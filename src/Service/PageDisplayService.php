...
class PageDisplayService
{
    ...
    private function getDefaultPageTitleMap(): array
    {
        ...
        return $this->defaultPageTitleMapCache = [
            ...
            'app_rh' => 'Ressources humaines',
            'app_compta' => 'Comptabilite',
            'app_production' => 'Production',
            'app_prestation' => 'Prestation',
            'app_sinistre' => 'Sinistre',
            'app_serviceentreprise' => 'Service entreprise',
            'app_controleinterne' => 'Controle interne',
            'app_communication' => 'Communication',
            'app_relationclient' => 'Relation client',
            'app_marketing' => 'Marketing',
            'app_vente' => 'Vente',
